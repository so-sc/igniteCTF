    ...
    <div className="flex flex-col w-full h-full justify-between">
      ...
      <div className="flex flex-col w-full p-4 justify-between items-center ">
        ...
        <p className="text-base text-justify mb-5">
          If you want to befriend the computer you must know how to talk to it,
          that's what coding is all about, execute this code using an online
          python compiler and the flag shall be yours.
        </p>
        <div
